...
<div class="container">
        ...
        <table class="table table-bordered table-hover mt-4">
            ...
            <tbody>
                @if (count($notif) <= 0)
                    <tr>
                        <td colspan="5" class="text-center">Bien! No hay ninguna solicitud pendiente.</td>
                    </tr>
                @else
                    @foreach ($notif as $itemnotif)
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <a href="{{ route('notifC.confirmar', $itemnotif->idNoti) }}"
                                    class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Marcar como atendido</a>
                            </td>
                        </tr>
                    @endforeach
                @endif
