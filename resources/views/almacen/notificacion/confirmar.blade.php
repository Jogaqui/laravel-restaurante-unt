...
<div class="container">
    <div class="row justify-content-center align-items-center" style="height: 100vh;">
        <div class="col-md-6 text-center">
            ...
            <hr>
            <form method="POST" action="{{route('notifA.destroy',$notifA->idNoti)}}">
                @method('delete')
                @csrf
                <button type="submit" class="btn btn-danger btn-lg"><i class="fas fa-check-square"></i> Sí, eliminar</button>
                <a href="{{route('notifA.cancelar')}}" class="btn btn-primary btn-lg"><i class="fas fa-times-circle"></i> No, cancelar</a>
            </form>
        </div>
        <div class="col-md-6 text-center">
