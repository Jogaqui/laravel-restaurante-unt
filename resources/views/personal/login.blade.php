...
@section('content')
    ...
    <form action="{{route('loginPer')}}" method="POST" >
        @csrf
        <div align="center">
            <img src="img/image1.png" width="220cm" alt="#">
        </div>
        <h2 align="center" style="margin: 20px; color:white">RESTAURANT "U.N.T."</h2>
        <h5 align="center" style="margin: 20px; color:#ffc44c">Subsistema Personal</h5>
        ...
        <div class="mb-3" align="center">
            <a href="{{route('personal.register')}}">
