...
@section('content')
    ...
    <form action="{{ route('marketing.register') }}" method="POST" style="text-align: center">
        @csrf
        <h2>CREAR CUENTA</h2>
        @include('layout.mensaje')
        <div class="form-floating mb-3">
            <input type="text" placeholder="username" name="username" class="form-control" id="exampleInputEmail1"
        ...
        <div style="align-content: center"">
            <a href="{{ route('marketing.login.show') }}">
